...
def render_profile_editor(
    *,
    ...
    save_clicked = st.button("Save Profile", type="primary")

    name_value = name.strip()
    description_value = description.strip()
    prepared_description = description_value or None
    ...
    profile_payload: dict[str, Any] = {
        ...
        "name": name_value or DEFAULT_PROFILE_NAME,
    ...
    draft_profile = dict(profile_data)
    draft_profile.update(profile_payload)

    if save_clicked:
        saved = service.save_profile(profile_payload)
    ...
    return ProfileEditorResult(profile=draft_profile)
